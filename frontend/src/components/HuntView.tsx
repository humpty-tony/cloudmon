...
export function HuntView({filter}:{filter:QueryFilter}) {
  ...
  const [first,setFirst]=useState(""),[second,setSecond]=useState(""),[group,setGroup]=useState<HuntOptions["group"]>("credential"),[minutes,setMinutes]=useState(15),[useFilter,setUseFilter]=useState(false);
